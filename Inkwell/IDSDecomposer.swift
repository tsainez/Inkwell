...
// MARK: - Logger
private let logger = Logger(subsystem: "com.inkwell", category: "IDSDecomposer")
...
enum IDSDecomposer {
    ...
    private static let fallbackMap: [String: IDSEntry] = {
        ...
        do {
            ...
            logger.error("failed to decode IDS_fallback.json — \(String(describing: error), privacy: .private)")
            return [:]
        }
    }()
}
